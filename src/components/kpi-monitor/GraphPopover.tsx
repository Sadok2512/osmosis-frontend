...
const GraphPopover: React.FC<GraphPopoverProps> = ({ graphConfig: ext, onGraphConfigChange }) => {
        ...
        <div className="space-y-2.5">
          ...
          <div className="pt-2 border-t border-border/30">
            ...
            <FieldRow label="Intensité">
              ...
              ]} onChange={v => set({ gridIntensity: v as any })} />
            </FieldRow>
            <div className="flex items-center justify-between min-h-[32px]">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-1.5">
                {['transparent', '#f8fafc', '#0f172a'].map(c => (
                  <button
                    key={c}
                    onClick={() => set({ backgroundColor: c, transparentBg: c === 'transparent' })}
                    className={cn(
          ...
          <div className="pt-2 border-t border-border/30">
            ...
            {graph.showLegend && (
              <FieldRow label="Position">
                ...
                ]} onChange={v => set({ legendPosition: v as any })} />
              </FieldRow>
            )}
          </div>
        </div>
