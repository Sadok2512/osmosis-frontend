    ...
    <div className="flex-1 overflow-y-auto px-4 pb-4 pt-3">
      ...
      {showCreateDash && (
        <Dialog open={true} onOpenChange={(open) => { if (!open) { setShowCreateDash(false); setNewDashName(''); setCreateFilters({}); setCreateConditions([]); } }}>
          <DialogContent className="sm:max-w-[940px] w-[95vw] max-h-[88vh] overflow-visible p-0 gap-0 flex flex-col">
            ...
            <div className="px-6 py-5 space-y-5 flex-1 min-h-[384px] overflow-y-auto overflow-x-visible">
                    ...
                    <div className="grid grid-cols-3 gap-1.5 mb-2">
                      <button
                        onClick={async () => {
                          ...
                          await onSaveDashboard(db.id);
                          setSavedDashboardId(db.id);
                          setTimeout(() => setSavedDashboardId(prev => prev === db.id ? null : prev), 2000);
                        }}
                        disabled={isSaving}
