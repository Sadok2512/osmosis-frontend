          ...
          >
            ...
            <div className="flex items-center gap-2 mb-3 relative z-10">
              ...
              <Popover>
                ...
                <PopoverContent className="w-[280px] p-0 z-50 overflow-hidden" align="end" side="bottom">
                  <div className="px-3 py-2 bg-muted/30 border-b border-border/40">
                    <span className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Graph Settings</span>
                  </div>
                  <div className="px-3 py-8 flex flex-col items-center justify-center text-center">
                    <Settings2 className="w-8 h-8 text-muted-foreground/30 mb-2" />
                    <span className="text-[11px] text-muted-foreground">Settings coming soon</span>
                  </div>
                </PopoverContent>
              </Popover>
            </div>
