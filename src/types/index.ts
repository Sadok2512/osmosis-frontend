...
export type AppTab = 'list' | 'sites' | 'analytics' | 'bi' | 'radio' | 'traffic' | 'subscriber' | 'alerts' | 'detector' | 'settings' | 'docs' | 'ai_assistant' | 'dashboard_overview' | 'rag' | 'radio_profile' | 'backend_admin' | 'topologie' | 'kpi_monitor' | 'pm_dashboard' | 'parameters' | 'pulse_report' | 'agent_hub' | 'sentinel' | 'investigator' | 'ran_query' | 'topology' | 'precision_architect';